...
namespace PlataformaCreditos.Data.Migrations
{
    ...
    [Migration("20260925153312_Notificaciones")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlataformaCreditos.Models.SolicitudCredito", b =>
                {
                    ...
                    b.HasIndex("ClienteId", "FechaSolicitud");

                    b.ToTable("SolicitudesCredito", null, t =>
                        {
                            t.HasTrigger("TR_SolicitudesCredito_Aprobacion_Insert");

                            t.HasTrigger("TR_SolicitudesCredito_Aprobacion_Update");

                            t.HasCheckConstraint("CK_SolicitudesCredito_Estado_Valido", "\"Estado\" IN ('Pendiente', 'Aprobado', 'Rechazado')");

                            t.HasCheckConstraint("CK_SolicitudesCredito_Monto_Positivo", "\"MontoSolicitado\" > 0");

                            t.HasCheckConstraint("CK_SolicitudesCredito_Rechazo_ConMotivo", "\"Estado\" <> 'Rechazado' OR (\"MotivoRechazo\" IS NOT NULL AND length(trim(\"MotivoRechazo\")) > 0)");
                        });
                });
            ...
            modelBuilder.Entity("PlataformaCreditos.Models.Cliente", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("PlataformaCreditos.Models.Cliente", "UsuarioId")
            ...
            modelBuilder.Entity("PlataformaCreditos.Models.Notificacion", b =>
                {
                    b.HasOne("PlataformaCreditos.Models.SolicitudCredito", null)
                        .WithMany()
